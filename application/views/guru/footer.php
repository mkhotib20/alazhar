    ...
    <footer class="sticky-footer bg-white">
      <div class="container my-auto">
        <div class="copyright text-center my-auto">
          <span>Copyright &copy; SMPIA 13 Surabaya </span>
        </div>
      </div>
    </footer>
    <!-- End of Footer -->
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="<?php echo base_url('login/logout/2') ?>">Logout</a>
        </div>
      </div>
    </div>
  </div>
...
<div class="modal fade" id="deleteBerita" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <script type="text/javascript">
    $('#deleteBerita').on('show.bs.modal', function (event) {
      ...
      modal.find('#yes').attr('href', '<?php echo base_url("guruManagement/delete/") ?>'+id+'/'+table+'/'+where+'/'+page)
  ...
  <script>
    $('.summernote').summernote({
      placeholder: 'Masukan konten berita disini',
      tabsize: 1,
      height: 300
    });
