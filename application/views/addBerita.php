...
?>
      ...
      <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
               <?php echo form_open_multipart('berita/uploadberita') ?>
                  <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                      <input required="" autofocus="" type="text" class="form-control " placeholder="Judul Berita (Indonesia)" name="judul">
                    </div>
                    <div class="col-sm-6 mb-3 mb-sm-0">
                  ...
                  <div class="form-group">
                    <input required=""  onchange="check()" <?php if ($kat==3) {echo 'accept=".img, .png, .jpg, .jpeg, .pdf, .doc,.docx"'; }else{echo 'accept=".img, .png, .jpg, .jpeg"';} ?> id="imgInp" type="file" name="gambar">
                    <br>
                    <center><img src="" alt="Cover Berita" id="blah"></center>
                  </div>
                  <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                      <label>Konten Bahasa Indonesia (Maksimal 2000 Karakter)</label>
                      <textarea required=""  class="summernote" name="konten"></textarea>
                    </div>
                    <div class="col-sm-6 mb-3 mb-sm-0">
                      <label>Content in English (Maksimal 2000 Karakter)</label>
